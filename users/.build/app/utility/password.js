...
const ValidatePassword = (enterPassword, savePassword, salt) => __awaiter(void 0, void 0, void 0, function* () {
    return ((yield (0, exports.GetHashedPassword)(enterPassword, salt)) == savePassword);
});
exports.ValidatePassword = ValidatePassword;
const GetToken = ({ email, phone, userType, user_id }) => {
